...
const CORPORA = {
  bsb: { service: 'bsb-archive', agent: 'qbsb.impact', edition: 'demo-licensed' },
...
const CORPORA=[{key:'bsb',label:'QBSB',short:'bsb',agent:'qbsb.impact'},{key:'lbsb',label:'Licensed BSB',short:'lbsb',agent:'lbsb.impact'},{key:'validator',label:'Validator',short:'validator',agent:'demo-validator.impact'},{key:'resolver',label:'Resolver agent',short:'scripture-resolver',agent:'scripture-resolver.impact'}];
