...
app.get('/custody/vault-key/server-info', (c) =>
  c.json({
    ...
    defaultResources: [RESOURCE_PERSON_PII, RESOURCE_ORG_SENSITIVE, RESOURCE_PROFILE, `${VAULT_RECORD_PREFIX}impact-profile`, `${VAULT_RECORD_PREFIX}impact-entitlements`, `${VAULT_RECORD_PREFIX}impact-org-profile`, `${VAULT_RECORD_PREFIX}impact-relationships`],
